 ...
 */
package br.org.coletivoJava.integracoes.restWordpress.implementacao.oauth;
 ...
 * @author sfurbino
 */
public class UtilIntegradorWordpress {
    ...
    public static String buildUrlRequisicao(String pUrlServidor, String pAssinatura) {
        String securedUrl = String.format(URL_SECURED_FORMAT, pUrlServidor, pAssinatura);
        return securedUrl;
    }
